module Admin
  class VisitsController < Admin::ApplicationController
    ...
    private def visit_params
      params.require(:visit).permit(:visaWith, :countryCode, :paidAmount, :creditAmount, :debitAmount, :actualCost, :salePrice, :profit, :status,:name, :description, :visaType, :days, :phone, :quantity, :child, :infant, :adult)
    end
  end
end
